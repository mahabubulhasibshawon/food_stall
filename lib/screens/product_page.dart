                                ...
                                child: Column(
                                  ...
                                  children: [
                                          ...
                                          children: [
                                            ...
                                            RichText(
                                                ...
                                                text: TextSpan(children: [
                                                  ...
                                                  TextSpan(text: "${widget.productData['rest']}", style: textTheme.titleSmall!.apply(color: COLOR_GREY))
                                                ])),
                                          ],
                                        ),
                                        RichText(
                                            ...
                                            text: TextSpan(children: [
                                              ...
                                              TextSpan(text: "${widget.productData['price']}", style: textTheme.headlineMedium!.apply(color: COLOR_ORANGE))
                                            ])),
                                      ],
                                    ),
                                    addVerticalSpace(20),
                                        ...
                                        children: [
                                          RichText(
                                              ...
                                              text: TextSpan(children: [
                                                ...
                                                TextSpan(text: "${widget.productData['rating']}", style: textTheme.bodyMedium!.apply(fontWeightDelta: 4))
                                              ])),
                                          RichText(
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(children: [
                                                WidgetSpan(child: Icon(Icons.access_time_sharp, color: Colors.red, size: 15)),
                                                TextSpan(text: " 18 Mins", style: textTheme.bodyMedium!.apply(fontWeightDelta: 4))
                                              ])),
                                          RichText(
                                              overflow: TextOverflow.ellipsis,
                                              text: TextSpan(children: [
                                                WidgetSpan(child: Icon(Icons.location_on, color: Colors.green, size: 15)),
                                                TextSpan(text: "2.3 KM" , style: textTheme.bodyMedium!.apply(fontWeightDelta: 4))
                                              ])),
                                        ],
                                      ),
                                    ),
                                    ...
                                    Text(
                                      ...
                                      style: textTheme.titleSmall!.apply(heightDelta: 2.0),
                                    ),
